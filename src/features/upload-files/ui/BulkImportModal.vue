      ...
      <div class="p-8">
        ...
        <div v-if="currentStep === 'upload'" class="space-y-6">
          <div>
            ...
            <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-12 hover:border-gray-400 transition">
              <input
                type="file"
                accept=".xlsx,.xls"
              ...
              <div class="text-center">
                ...
                <div class="text-gray-500">
                  <span v-if="isLoadingColumns" class="text-blue-600">Чтение файла...</span>
                  <span v-else-if="!file">Перетащите файл или нажмите для выбора</span>
                  <span v-else class="text-blue-600">{{ file.name }}</span>
                </div>
              </div>
            </div>
          </div>
